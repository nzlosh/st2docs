 ...
 * StackStorm v3.9 has received a lot of work on compatibility updates.
   - Linux distribution support for Ubuntu 22.04 and RockyLinux 9 have been added.  Support for Ubuntu 18.04 Focal and CentOS 7 have been removed.
   - Python support for versions from ``3.8`` to ``3.11``.  Version ``3.6`` compatibility is no longer supported.
   - MongoDB compatibility ranges from ``3.x`` to ``v7.x`` for the official MongoDB database.
